...
export function SummaryTiles({
  ...
  return (
    <div className='grid gap-5 md:grid-cols-2 xl:grid-cols-4'>
      <div className='dashboard-reveal' style={getRevealStyle(70)}>
        <SummaryTile
          badge='Projected'
          detail={periodLabel}
          footer='Income'
      ...
      <div className='dashboard-reveal' style={getRevealStyle(140)}>
        <SummaryTile
          badge='Editable'
      ...
      <div className='dashboard-reveal' style={getRevealStyle(210)}>
        <SummaryTile
      ...
      <div className='dashboard-reveal' style={getRevealStyle(280)}>
        <SummaryTile
          badge='Rate'
